<x-layout>
    ...
    <form method="POST" action="/register">{{-- this is the form for creating a new job, after submitting the form it make a post request to /jobs ---}}
          ...
          <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <x-form-field>
                ...
                <div class="mt-2">
                  <x-form-input name="password_confirmation" id="password_confirmation" type="password" required />{{-- the name should be password confirmation--}}
